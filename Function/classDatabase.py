...
DB_STUDENT = 'student'
db = Database()
db.creatTable(DB_STUDENT, '(`name` TEXT, `msv` TEXT, `time_in` INT DEFAULT NULL, `time_out` INT DEFAULT NULL, `status` TEXT DEFAULT "Chưa điểm danh hôm nay", `dateEnd` INT DEFAULT NULL)')